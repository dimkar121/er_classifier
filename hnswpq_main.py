...
if __name__ == '__main__':
    ...
    print(f"HNSWPQ recall={round(tp / matches, 2)} precision={round(tp / (tp + fp), 2)} total matching time={end_time - start_time} seconds.")
