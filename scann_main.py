...
if __name__ == '__main__':
    ...
    num_leaves = int(np.sqrt(len(scholar_embeddings)))
    ...
    searcher = scann.scann_ops_pybind.builder(scholar_embeddings, 10, "dot_product") \
    ...
    print(f"Scann recall={round(tp / matches, 2)} precision={round(tp / (tp + fp), 2)} total matching time={end_time-start_time} seconds.")
