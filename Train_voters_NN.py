...
df1 = pd.read_parquet(f"./data/votersA_{model}.pqt")
df2 = pd.read_parquet(f"./data/votersB_{model}.pqt")
gold_standard = pd.read_csv(f"./data/truth_voters.csv", sep=",", encoding="utf-8", keep_default_na=False)
